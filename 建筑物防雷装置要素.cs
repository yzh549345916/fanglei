...
namespace fangleinew
{
    public class 建筑物防雷装置要素 : IDataErrorInfo, INotifyPropertyChanged
    {
        ...
        [Display(Description = "项目名称", GroupName = "01.基本信息",Order =3)]
        public string 项目名称
        {
            get { return xmName; }
            set
        ...
        [Display(Description = "地址", GroupName = "01.基本信息", Order = 4)]
        public string 地址
        {
            get { return address; }
            set
        ...
        [Display(Description = "联系人", GroupName = "01.基本信息", Order = 5)]
        public string 联系人
        {
            get { return lxPeople; }
            set
        ...
        [Display(Description = "天气", GroupName = "01.基本信息", Order = 7)]
        ...
        private string yjbz;
        [Display(Description = "依据标准", GroupName = "01.基本信息", Order = 8)]
        public string 依据标准
        {
            get { return yjbz; }
            set
        ...
        private double high;
        [Display(Description = "高度，填写-1则生成报告时为/", GroupName = "02.建筑物",Order =9)]
        public double 高度
        {
            get { return high; }
            set
        ...
        [Display(Description = "面积1，填写-1则生成报告时为/", GroupName = "02.建筑物", Order = 10)]
        public double 面积1
        {
            get { return mianji1; }
            set
        ...
        [Display(Description = "面积2，填写-1则生成报告时为/", GroupName = "02.建筑物", Order = 11)]
        public double 面积2
        {
            get { return mianji2; }
            set
        ...
        [Display(Description = "地上层数，填写-1则生成报告时为/", GroupName = "02.建筑物", Order = 12)]
        public int 地上层数
        {
            get { return cengshu1; }
            set
        ...
        [Display(Description = "地下层数，填写-1则生成报告时为/", GroupName = "02.建筑物", Order = 13)]
        public int 地下层数
        {
            get { return cengshu2; }
            set
        ...
        [Display(Description = "接闪杆接地电阻，填写-1则生成报告时为/", GroupName = "03.接闪装置", Order = 19, ShortName = "接闪杆接地电阻")]
        public double Jdzz1
        {
            get { return jdzz1; }
            set
        ...
        [Display(Description = "接闪带接地电阻，填写-1则生成报告时为/", GroupName = "03.接闪装置", Order = 24, ShortName = "接闪带接地电阻")]
        ...
        [Display(Description = "接闪网络接地电阻，填写-1则生成报告时为/", GroupName = "03.接闪装置", Order = 29, ShortName = "接闪网络接地电阻")]
        ...
        [Display(Description = "金属结构间等电位连接，填写-1则生成报告时为/", GroupName = "04.大型金属构件", Order = 31, ShortName = "金属结构间等电位连接")]
        ...
        [Display(Description = "金属结构与接闪带连接，填写-1则生成报告时为/", GroupName = "04.大型金属构件", Order = 32, ShortName = "金属结构与接闪带连接")]
        ...
        public string this[string columnName]
        {
            get
            {
                switch(columnName)
                {
                    ...
                    case "高度":
                        return this.高度  >=-1 ? string.Empty : "输入的值必须大于等于-1";
                    case "面积1":
                        return this.面积1 >= -1 ? string.Empty : "输入的值必须大于等于-1";
                    case "面积2":
                        return this.面积2 >= -1 ? string.Empty : "输入的值必须大于等于-1";
                    case "地上层数":
                        return this.地上层数 >= -1 ? string.Empty : "输入的值必须大于等于-1";
                    case "地下层数":
                        return this.地下层数 >= -1 ? string.Empty : "输入的值必须大于等于-1";

                    case "Jdzz1":
                        return this.Jdzz1 >= -1 ? string.Empty : "输入的值必须大于等于-1";
